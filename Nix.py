...
android_models=[]
try:
    xx = requests.get('https://github.com/mrx-com/MRX-/blob/main/MRX-.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/mrx-com/MRX-/blob/main/MRX-.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
──────────────────────────────────────────────────
\033[1;92m Owner   :            MR:MRX
\033[1;92m Facebook:            Mr:MRX
\033[1;92m Github  :            Mr-MRX
\033[1;92m Version :            0.0.7
──────────────────────────────────────────────────""")
def linex():
        print('\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
def clear():
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('JONY1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
